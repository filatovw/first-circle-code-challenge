...
with DAG(
    dag_id="report_monthly_user_stats",
    ...
    create_pet_table = SQLExecuteQueryOperator(
        ...
        DELETE FROM report_monthly_user_stats;

        INSERT INTO report_monthly_user_stats (user_id, month, sent_count, received_count, total_sent, total_received)
        SELECT
